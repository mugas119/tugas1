...
<body>
    ...
    if($this->session->flashdata('sukses')) {  
        ...
        <p>Password:</p>  <p><input type="password" name="password" value="<?php echo set_value('password'); ?>"/></p>  
        <p> <?php echo form_error('password'); ?> </p> 
        <input type="submit" name="btnSubmit" value="Login" /></p>  <?php echo form_close();?>  
